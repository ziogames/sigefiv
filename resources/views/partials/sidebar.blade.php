    ...
    <div class="sidebar-header border-bottom">
        ...
        <div class="sidebar-brand d-flex flex-column align-items-center py-3">
            ...
            @if (!empty($configuracionGlobal?->logo))
                <img src="{{ asset('storage/' . $configuracionGlobal->logo) }}" alt="Logo" style="height:55px;"
                    class="mb-2">
            @endif
        ...
        <button class="btn-close d-lg-none" type="button" onclick="toggleSidebarMovil()">
        </button>
    ...
    <ul class="sidebar-nav" data-coreui="navigation" data-simplebar>
        ...
        <li class="nav-title">
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link" href="{{ route('asambleas.index') }}">
